...
public class PendulumLayer<T extends LivingEntity, M extends EntityModel<T> & ArmedModel & HeadedModel> extends ItemInHandLayer<T, M>
{
	...
	private static final ItemStack WEIGHT = new ItemStack(CMItems.PENDULUM_WEIGHT.get());
	...
	{
		if(stack.getItem() != CMItems.PENDULUM.get() || stack.isEmpty() || player.getUseItem() != stack)
			return;
