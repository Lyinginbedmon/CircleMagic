...
public class CMBlockEntities
{
	...
	public static final RegistryObject<BlockEntityType<StatueBlockEntity>> STATUE = BLOCK_ENTITIES.register("statue", () -> BlockEntityType.Builder.of(StatueBlockEntity::new, CMBlocks.STATUE.get()).build(Util.fetchChoiceType(References.BLOCK_ENTITY, "statue")));
