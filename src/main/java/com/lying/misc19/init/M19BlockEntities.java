...
public class M19BlockEntities
{
	...
	public static final RegistryObject<BlockEntityType<MagicTreeBlockEntity>> MAGIC_TREE = BLOCK_ENTITIES.register("magecrafted_bough", () -> BlockEntityType.Builder.of(MagicTreeBlockEntity::new, M19Blocks.MAGIC_TREE.get()).build(Util.fetchChoiceType(References.BLOCK_ENTITY, "magecrafted_bough")));
